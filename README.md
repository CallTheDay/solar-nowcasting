# Solar Nowcasting Overview
Short-term cloud and PV power forecasting ('nowcasting') using a sky-facing camera on a Raspberry Pi. Visualization via a website with a simple GUI.
